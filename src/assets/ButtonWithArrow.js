...
const ButtonWithArrow = ({buttonText, eventHandler}) => {
  return (
    <button className="flex justify-between items-center text-rbWhite bg-rbBlue border-1 border-rbWhite h-11 w-80 border-2 rounded-full" onClick={eventHandler}>
