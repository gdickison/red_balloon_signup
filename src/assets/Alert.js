...
const Alert = ({message, closeAlert}) => {
  return (
    <div className="flex justify-around items-center w-80 h-20 my-[20px] mx-auto absolute top-40 left-0 right-0 bg-rbWhite border-4 border-rbBlue rounded-lg shadow-lg text-rbRed">
